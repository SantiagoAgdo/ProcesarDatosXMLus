package com.mibanco.procesardatosxml.us.service.impl;

import com.mibanco.procesardatosxml.us.dto.Informes;
import com.mibanco.procesardatosxml.us.service.contract.ProcesarDatosService;
...
@ApplicationScoped
public class ProcesarDatosXMLImpl implements ProcesarDatosService {
    ...
    public Informes procesarDatosXml(byte[] xml) throws Exception {
        ...
        LOG.info("Finaliza proceso tranformacion XML");
        return informes;
